...
class MainWindow(Screen):
    def __init__(self, **kw):
        ...
        self.delete_expense_button = Button(text='Poista viimeinen kulu', on_press=self.delete_last_expense)
...
class ReportWindow(Screen):
    def __init__(self, **kw):
        ...
        self.all_the_information_button = Button(text="Taulukko", on_press=self.generate_information, size_hint=(1, 0.4))
        self.generate_report_button = Button(text='Diagrammi', on_press=self.generate_report, size_hint=(1, 0.4))
...
class InformationWindow(Screen):
    def __init__(self, **kw):
        ...
        #otsikko seuraavalle sivulle
        self.label4 = Label(text= kuukausi +"n kaikki kulut yhteensä: " + str(kulut_yhteensa) + " euroa", size_hint=(1, 0.1))
